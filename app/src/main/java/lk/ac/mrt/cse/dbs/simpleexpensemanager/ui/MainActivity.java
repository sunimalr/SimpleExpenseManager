...
import lk.ac.mrt.cse.dbs.simpleexpensemanager.control.PersistentDbDemoExpenseManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpenseManagerDbHelper dbHelper = new ExpenseManagerDbHelper(MainActivity.this);

        /***  Begin generating dummy data for In-Memory implementation  ***/
        expenseManager = new PersistentDbDemoExpenseManager(dbHelper);
